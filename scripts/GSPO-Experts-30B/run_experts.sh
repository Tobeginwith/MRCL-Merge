...
echo "Training: temperature=0.8, P0 batch=2 x 8 GPUs x accumulation 16, max completion=4096"
echo "Conda path: ${CONDA_PATH}"
echo "Training environment: trlQwenVllm"
echo "Evaluation environment: vllmQwen"
echo "Inference: temperature=1.0 (defined in src/eval/inference.py)"
