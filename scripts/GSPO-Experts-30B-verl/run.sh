...
for TASK_ID in ${TASK_IDS:-1}; do
    case "$TASK_ID" in
        1) TASK=MedBookVQA; MAX_STEPS=300; IMAGE_MIN_PIXELS=$((128*32*32)); IMAGE_MAX_PIXELS=$((512*32*32)) ;;
        2) TASK=Navigation; MAX_STEPS=600; IMAGE_MIN_PIXELS=$((128*32*32)); IMAGE_MAX_PIXELS=$((512*32*32)) ;;
